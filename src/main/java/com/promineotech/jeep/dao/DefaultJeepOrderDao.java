...
public class DefaultJeepOrderDao implements JeepOrderDao {
	...
	public Order saveOrder(Customer customer, Jeep jeep, Color color, Engine engine, Tire tire, BigDecimal price,
			List<Option> options) {
		// Method call to generate the Sql for saving the order fields and current
		// parameter values into the oorders table.
		SqlParams params = generateInsertSql(customer, jeep, color, engine, tire, price);

		// keyholder catches orderPK after calling update so we can save the order
		// options.
	...
	// Saves the options in the order_options table.
	...
	private SqlParams generateInsertSql(Option option, Long orderPK) {
		...
		return params;
	} // end generateInsertSql for option
	...
	private SqlParams generateInsertSql(Customer customer, Jeep jeep, Color color, Engine engine, Tire tire,
		...
		return params;
	} // end generateInsertSql for orders
	...
	} // end CLASS TireResultSetExtractor
	...
	} // end CLASS EngineResultSetExtractor
	...
	} // end CLASS ColorResultSetExtractor
	...
	} // end CLASS ModelResultSetExtractor
	...
	} // end CLASS CustomerResultSetExtractor
